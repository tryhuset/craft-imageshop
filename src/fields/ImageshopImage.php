...
namespace trydig\craftimageshop\fields;

use trydig\craftimageshop\CraftImageshop;
use trydig\craftimageshop\assetbundles\imageshopimagefield\ImageshopImageFieldAsset;
use trydig\craftimageshop\models\ImageArrayModel;
...
class ImageshopImage extends Field implements PreviewableFieldInterface
{
    ...
    {
        return CraftImageshop::$plugin->image->serialize($value);
    }
    ...
    {
        $settings = CraftImageshop::$plugin->settings;
        $token = $settings->token;
        $interfaceName = $settings->interfaceName;

        // Render the settings template
        return Craft::$app->getView()->renderTemplate(
            'craft-imageshop/_components/fields/ImageshopImage_settings',
            [
                'field' => $this,
                'name' => $interfaceName,
                'token' => $token
    ...
    public function getInputHtml(mixed $value, ?\craft\base\ElementInterface $element = null): string
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'craft-imageshop/_components/fields/ImageshopImage_input',
            [
